...
\end{center}
   \caption{Snapshot of our collected data. (a) Image. (b) Rendered map with 3D points. (c) Rendered map with ghost points removed. 
   (d) Rendered depth map. (e) Rendered label map with 3D squares. (f) Merged label map with object and sky. We show the color legend in this dataset at top.}
\label{fig:data}
\end{figure}
